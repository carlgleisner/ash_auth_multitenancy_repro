...
config :myapp, MyappWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "RRTFIDCUR/qwTxdwu1MoQaftBh8s9bWj4YVRaai5dYCKS7axvrFh39X2V28yj2um",
  watchers: [
...
config :myapp, dev_routes: true, token_signing_secret: "2MI+NtPK6Fe6bGmogE4Y3SPMYPhE351D"
